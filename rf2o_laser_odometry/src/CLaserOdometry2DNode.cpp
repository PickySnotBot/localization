...
void CLaserOdometry2DNode::publish()
{
  ...
  // Covariance matrix from rf2o_ref.cov_odo
  // The covariance matrix is stored in a 6x6 matrix (36 elements)
  // Order: [x, y, z, roll, pitch, yaw]
  odom.pose.covariance[0] = rf2o_ref.cov_odo(0, 0); // x-x covariance
  odom.pose.covariance[1] = rf2o_ref.cov_odo(0, 1); // x-y covariance
  odom.pose.covariance[5] = rf2o_ref.cov_odo(0, 2); // x-yaw covariance
  odom.pose.covariance[6] = rf2o_ref.cov_odo(1, 0); // y-x covariance
  odom.pose.covariance[7] = rf2o_ref.cov_odo(1, 1); // y-y covariance
  odom.pose.covariance[11] = rf2o_ref.cov_odo(1, 2); // y-yaw covariance
  odom.pose.covariance[30] = rf2o_ref.cov_odo(2, 0); // yaw-x covariance
  odom.pose.covariance[31] = rf2o_ref.cov_odo(2, 1); // yaw-y covariance
  odom.pose.covariance[35] = rf2o_ref.cov_odo(2, 2); // yaw-yaw covariance

  // Set the twist covariance 
  odom.twist.covariance[0] = rf2o_ref.cov_odo(0, 0); // vx-vx covariance
  odom.twist.covariance[1] = rf2o_ref.cov_odo(0, 1); // vx-vy covariance
  odom.twist.covariance[5] = rf2o_ref.cov_odo(0, 2); // vx-vyaw covariance
  odom.twist.covariance[6] = rf2o_ref.cov_odo(1, 0); // vy-vx covariance
  odom.twist.covariance[7] = rf2o_ref.cov_odo(1, 1); // vy-vy covariance
  odom.twist.covariance[11] = rf2o_ref.cov_odo(1, 2); // vy-vyaw covariance
  odom.twist.covariance[30] = rf2o_ref.cov_odo(2, 0); // vyaw-vx covariance
  odom.twist.covariance[31] = rf2o_ref.cov_odo(2, 1); // vyaw-vy covariance
  odom.twist.covariance[35] = rf2o_ref.cov_odo(2, 2); // vyaw-vyaw covariance
